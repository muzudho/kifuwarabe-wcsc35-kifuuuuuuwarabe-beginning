...
class O3QuiescenceSearchRoutines(SearchRoutines):
    ...
    @staticmethod
    def extend_vertical_edges_o3(pv_list, search_context_model):
        """縦の辺を伸ばす。
        """
        ...
        for pv in pv_list:
            ...
            if pv.termination_model_pv is not None:     # 探索不要なら。
                ...
                if len(remaining_moves) == 0:
                    ...
                    # # TODO ３手目を指す。
                    # next_pv.set_deprecated_rooter_backwards_plot_model_in_backward_pv(O4QuiescenceSearchRoutines.move_all_pv_o4(
