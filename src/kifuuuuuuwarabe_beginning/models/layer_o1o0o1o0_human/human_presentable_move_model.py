...
class HumanPresentableMoveModel:
    ...
    def __init__(self, src_sq_obj, dst_sq_obj, moving_pt_str, is_drop):
    ...
    def stringify(self):
        ...
        # ［移動元マス］
        src_file_str = StringResourcesModel.zenkaku_suji_list()[self._src_sq_obj.file]
        src_rank_str = StringResourcesModel.kan_suji_list()[self._src_sq_obj.rank]

        # ［移動先マス］
        dst_file_str = StringResourcesModel.zenkaku_suji_list()[self._dst_sq_obj.file]
        dst_rank_str = StringResourcesModel.kan_suji_list()[self._dst_sq_obj.rank]
        ...
        return f"{src_file_str}{src_rank_str}.{dst_file_str}{dst_rank_str}{self.moving_pt_str}{drop_kanji()}"
