...
class WillToTakeThePieceWithoutLosingAnything():
    ...
    @staticmethod
    def will_after_move(move, cap_sq, cap_type, board):
        """
        Parameters
        ----------
        cap_type : int
        ...
        # 敵角があるか？
        pc2 = board.piece(bottom_right_sq)
        pt2 = cshogi.piece_to_piece_type(pc2)

        if board.turn == Piece.turn(pc2):
